...
HD_PWD='C:/Vivado/NEXYS 4 DDR_Project/OV7670_VGA/OV7670_VGA_RGB/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log OV7670_VGA_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source OV7670_VGA_TOP.tcl -notrace
