...
HD_PWD='C:/Vivado/NEXYS 4 DDR_Project/OV7670_VGA/OV7670_VGA_RGB/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OV7670_VGA_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OV7670_VGA_TOP.tcl
