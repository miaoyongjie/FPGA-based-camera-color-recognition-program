...
HD_PWD='C:/Users/51249/Documents/Tencent Files/512491013/FileRecv/Camera_RGB_Demo/Camera_RGB_Demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Camera_RGB_Demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Camera_RGB_Demo.tcl
